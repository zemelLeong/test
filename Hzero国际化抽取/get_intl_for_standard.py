...
result_df["module_bef"], result_df["module_aft"], result_df["module_code"] = result_df["codes"].str.split(".", 2).str
result_df["module"] = result_df["module_bef"].str.cat(result_df["module_aft"], sep=".")
result_df = result_df[["module", "module_code", "values", "intl", "file"]]

result_df.to_excel("{0}.xlsx".format(os.path.basename(os.path.dirname(os.path.abspath("__file__")))), index=False)
